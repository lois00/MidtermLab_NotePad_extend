...
public final class NotePad {
    ...
    public static final class Notes implements BaseColumns {
        ...
        /**
         * The other sort orders for this table
         */
        /**
         * order by modified date ascending
         */
        public static final String SORT_ORDER_MODIFIED_ASC = "modified ASC";
        /**
        ...
        /**
         * 笔记背景色
         * Column name for the background color of note
         * <P>Type: INTEGER</P>
         */
        ...
        /**
         * 时间戳格式
         * the format for timestamp,which refers to column created and column modified
         */
